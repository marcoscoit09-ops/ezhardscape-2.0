...
export default function WorkSection() {
  ...
  return (
    <section className="w-full bg-[#F5F0E8] px-5 sm:px-10 md:px-20 py-20 md:py-28">
      <div className="max-w-[1120px] mx-auto">
        ...
        >
          ...
          <h2
            className="text-black text-[32px] sm:text-[44px] md:text-[56px] leading-none"
            style={{
              fontFamily:    "var(--font-fustat)",
              fontWeight:    800,
              letterSpacing: "clamp(-1px, -0.04em, -2.5px)",
            }}
          >
        ...
        <motion.div
          ...
          className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-[14px] mb-10 md:mb-14"
        >
...
function ServiceCard({
  ...
  return (
    <Link href={href} className="block">
      <div
        className="group relative overflow-hidden cursor-pointer w-full h-[138px] sm:h-[160px] md:h-[220px]"
        style={{
          borderRadius: "18px",
          border:       "1px solid rgba(0,0,0,0.08)",
          boxShadow:    "0 6px 32px rgba(0,0,0,0.10), 0 1px 0 rgba(255,255,255,0.7) inset",
        ...
        onMouseEnter={(e) => {
          ...
          (e.currentTarget as HTMLDivElement).style.boxShadow =
            "0 20px 50px rgba(0,0,0,0.18), 0 1px 0 rgba(255,255,255,0.7) inset";
        }}
        onMouseLeave={(e) => {
          (e.currentTarget as HTMLDivElement).style.transform = "scale(1) translateY(0px)";
          (e.currentTarget as HTMLDivElement).style.boxShadow =
            "0 6px 32px rgba(0,0,0,0.10), 0 1px 0 rgba(255,255,255,0.7) inset";
        }}
      >
        <Image
          src={photo}
